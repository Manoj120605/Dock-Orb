...
export type DomainType = 'software' | 'mechanical' | 'electrical' | 'research' | 'cybersecurity' | 'general';
...
export type Capsule = ProjectCapsule | UserCapsule | TaskCapsule | ConversationCapsule | TeamCapsule;
